...
#define TLS_AUDIT_DICT_ALEVEL	"actual_level"		/* key */
#define TLS_AUDIT_DICT_PLEVEL	"policy_level"		/* key */
#define TLS_AUDIT_DICT_STATUS	"auth_status"		/* key */
#define TLS_AUDIT_DICT_PROTOCOL	"tlsprotocol"		/* key */
#define TLS_AUDIT_DICT_CIPHER	"ciphersuite"		/* key */
